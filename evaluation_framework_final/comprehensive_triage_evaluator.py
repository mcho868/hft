#!/usr/bin/env python3
"""
Comprehensive Medical Triage Evaluation Pipeline
...
2. Base models (SmolLM2, Gemma) with and without fine-tuned adapters
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--resume":
        ...
        # Full evaluation
        logger.info("🚀 Starting full comprehensive evaluation...")
        results = evaluator.run_comprehensive_evaluation()
    
    # Save final results
    output_file = f"comprehensive_evaluation_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
